...
public class ExampleStatemachine implements IExampleStatemachine {
	...
	public enum State {
		...
		main_region_Black,
		main_region_White,
		main_region_Winner__White,
		main_region_Winner__Black,
		$NullState$
	};
	...
	public void runCycle() {
		...
		for (nextStateIndex = 0; nextStateIndex < stateVector.length; nextStateIndex++) {
			...
			case main_region_White:
				...
				break;
			case main_region_Winner__White:
				main_region_Winner__White_react(true);
				break;
			case main_region_Winner__Black:
				main_region_Winner__Black_react(true);
				break;
			default:
				// $NullState$
			}
	...
	*/
	public boolean isStateActive(State state) {
		...
		case main_region_Winner__White:
			return stateVector[0] == State.main_region_Winner__White;
		case main_region_Winner__Black:
			return stateVector[0] == State.main_region_Winner__Black;
		default:
			return false;
		}
	}
	...
	*/
	...
	/* 'default' enter sequence for state Winner: White */
	private void enterSequence_main_region_Winner__White_default() {
		nextStateIndex = 0;
		stateVector[0] = State.main_region_Winner__White;
	}
	
	/* 'default' enter sequence for state Winner: Black */
	private void enterSequence_main_region_Winner__Black_default() {
		nextStateIndex = 0;
		stateVector[0] = State.main_region_Winner__Black;
	}
	...
	/* Default exit sequence for state Winner: White */
	private void exitSequence_main_region_Winner__White() {
		nextStateIndex = 0;
		stateVector[0] = State.$NullState$;
	}
	
	/* Default exit sequence for state Winner: Black */
	private void exitSequence_main_region_Winner__Black() {
		nextStateIndex = 0;
		stateVector[0] = State.$NullState$;
	}
	...
	private void exitSequence_main_region() {
		...
		case main_region_White:
			...
			break;
		case main_region_Winner__White:
			exitSequence_main_region_Winner__White();
			break;
		case main_region_Winner__Black:
			exitSequence_main_region_Winner__Black();
			break;
		default:
			break;
		}
		...
		if (try_transition) {
			if (react()==false) {
				if (sCInterface.black) {
					...
					if (((timeEvents[0]) && (sCInterface.getBlackTime()>0))) {
						exitSequence_main_region_Black();
						sCInterface.setBlackTime(sCInterface.getBlackTime() - 1);
						
						enterSequence_main_region_Black_default();
					} else {
						if (((timeEvents[1]) && (sCInterface.getBlackTime()==0))) {
							exitSequence_main_region_Black();
							enterSequence_main_region_Winner__White_default();
						} else {
							did_transition = false;
						}
					}
		...
		if (try_transition) {
			if (react()==false) {
				if (sCInterface.white) {
					...
					if (((timeEvents[2]) && (sCInterface.getWhiteTime()>0))) {
						exitSequence_main_region_White();
						sCInterface.setWhiteTime(sCInterface.getWhiteTime() - 1);
						
						enterSequence_main_region_White_default();
					} else {
						if (((timeEvents[3]) && (sCInterface.getWhiteTime()==0))) {
							exitSequence_main_region_White();
							enterSequence_main_region_Winner__Black_default();
						} else {
							did_transition = false;
						}
					}
	...
	private boolean main_region_Winner__White_react(boolean try_transition) {
		boolean did_transition = try_transition;
	...
	private boolean main_region_Winner__Black_react(boolean try_transition) {
		boolean did_transition = try_transition;
